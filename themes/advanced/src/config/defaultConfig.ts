...
const config: SiteConfig = {
  ...
  website: {
    title: "Luka Petshop Blog", // Homepage title
    titleShort: "Luka Petshop Blog", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    name: "Luka Blog", // Website name used for homescreen (PWA) and SEO
    description: "Blog donde se publican post de mascotas.", // Website description used for RSS feeds/meta description tag
    language: "en", // Sets the global HTML lang attribute
    logoUrl: "/logos/logo-1024.png", // Logo used for SEO
    url: "https://blog.lukamascotas.com.co", // Domain of your website without the pathPrefix
    rss: "/rss.xml", // Path to the RSS file
    rssTitle: "Luka RSS Feed", // Title of the RSS feed
